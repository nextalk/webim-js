...
webim.route( {
	...
	deactivate: _path + "data/refresh.php",	
	message: _path + "data/message.php",	
	presence: _path + "data/presence.php",	
	status: _path + "data/status.php",	
	setting: _path + "data/setting.php",	
	history: _path + "data/history.php",	
	...
	buddies: _path + "data/buddies.php",	
	notifications: _path + "data/notifications.php"
} );
